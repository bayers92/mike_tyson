class PersonalInfo < ActiveRecord::Base
	...
	has_attached_file :about_pic, styles: { small: "64x64", med: "200x200", large: "300x300" }, default_url: "/images/:style/missing.png"
